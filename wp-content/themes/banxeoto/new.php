				...
				<div class="row">
						...
						<div class="item-news">
							<div class="row">
								...
								<div class="col-8 text">
									...
									<p>Giới chức Thái Lan thông báo một người trong đội thợ lặn đã chết vào ngày 6/7 vì thiếu oxy trong quá trình giải cứu đội bóng đang mắc kẹt trong hang động.</p>
					...
					<div class="col-lg-3 d-none d-lg-block">
						...
						<div class="box-hightlight-news">
							...
							<div class="box-border">
								<div class="list-news">
									<a class="img" href=""><img class="img-fluid lh2-img" src="<?php bloginfo('template_directory'); ?>/img/a1.jpg" alt=""></a>
